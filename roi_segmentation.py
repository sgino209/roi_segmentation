# Reference: https://medium.com/swlh/roi-segmentation-contour-detection-and-image-thresholding-using-opencv-c0d2ea47b787

# Main steps:
# - Defining Region of Interest (ROI)
# - Detecting Contours in ROI (convex hull technique)
